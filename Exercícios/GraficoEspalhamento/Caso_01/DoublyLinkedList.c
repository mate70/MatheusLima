...
//trashNode: Nó sentinela (permite que mesmo a lista estando vazia ele aponta para um nó: (list->first=trashNode;)
...
void* dequeue(DoublyLinkedList *list) {
    ...
    void *data = first->data;        //Informação do nó a ser removida.
